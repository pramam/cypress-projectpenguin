...
describe("UserStory: DELETE API", () => {
  ...
  it(`should be able to delete record by id (mandatory fields)`, function () {
    ...
    // - POST /app/{appId}/record  <a record with mandatory fields only>
    // - Validate response of POST with `expect`
    // - Get the record id of the new record from the POST response
    // - Validate the response of GET with `expect`
  ...
  it(`should be able to delete record by id (all UI fields)`, function () {
    // We are going to do the following:
